...
STR.uz = {
  brand_top: "TRADE", brand_bottom: "BOT", status: "STANDART",
  search: "Aktiv qidirish...",
  lang_title: "Til", lang_ru: "Русский", lang_en: "English",
  blocks: {
    assets: { title: "AKTIVLAR",    sub: "121 vosita" },
    edu:    { title: "TA'LIM",      sub: "5 modul + kitoblar" },
    calc:   { title: "KALKULYATOR", sub: "Martingale + xavf" },
    news:   { title: "YANGILIKLAR", sub: "Kalendar · bugun 14" },
    ind:    { title: "INDIKATORLAR",sub: "6 klassik" },
  },
  assets_count_suffix: "aktiv",
  cats: { fiat: "Valyutalar", otc: "OTC valyutalar", crypto: "Kriptovalyutalar", stocks: "Aksiyalar", comm: "Xom ashyolar", idx: "Indekslar", fav: "Sevimlilar" },
  cat_short: { fiat: "💵 FX", otc: "💵 OTC", crypto: "₿ Kripto", stocks: "📊 Aksiya", comm: "🛢 Xom ashyo", idx: "📈 Indeks", fav: "⭐ Sevimli" },
  edu_tabs: { basics: "Savdo asoslari", books: "Kitoblar" },
  news_cols: { time: "Vaqt", prio: "Muhim.", left: "Qoldi", event: "Voqea" },
  news_time_fmt: (h, m) => `${h}s ${m}d`,
  analyze_market: "BOZORNI TAHLIL QILISH", analyze_loading: "ALGORITM ISHLAMOQDA...",
  scanning: "BOZOR SKANERLANMOQDA...", analyzing_signal: "SIGNAL TAHLIL QILINMOQDA...",
  analyzing_volatility: "VOLATILLIK TAHLIL QILINMOQDA...", finalizing: "BASHORAT YAKUNLANMOQDA...",
  buy: "SOTIB OLISH", sell: "SOTISH", market: "Bozor", time_label: "Vaqt",
  valid_until: "Amal qiladi", retry: "Qayta urinish", back: "Orqaga",
  tag_signal_ai: "AI SIGNAL", tag_signal: "SIGNAL", tag_edu: "TA'LIM",
  tag_ind: "INDIKATOR", tag_asset_analysis: "AKTIV TAHLILI",
  dir_up: "TEPAGA", dir_down: "PASTGA",
  probability: "Ehtimollik", expiration: "Muddati",
  entry: "Kirish", target: "Maqsad", accept_signal: "SIGNALNI QABUL QILISH",
  processing: "AI algoritmi ma'lumotlarni qayta ishlamoqda...",
  step_volatility: "› volatillik tekshiruvi",
  step_rsi: "› RSI + MACD hisobi",
  step_patterns: "› sham namunalari",
  demo_note: "⚠ Demo signal. Ishlab chiqarishda ML modeli chiqishi.",
  demo_note_market: "⚠ Demo signal. Ishlab chiqarishda ML/API chiqishi.",
  gate_loading: "Kirish tekshirilmoqda...",
  gate_channel_title: "Kanalga obuna bo'ling",
  gate_channel_desc: "Signallarga kirish uchun tahlil kanalimizga obuna bo'ling.",
  gate_channel_btn: "📣 Kanalni ochish", gate_check_btn: "Obuna bo'ldim, tekshirish",
  gate_broker_title: "Pocket Option'da ro'yxatdan o'tish",
  gate_broker_desc: "To'liq kirish uchun bizning sherikchilik linkimiz orqali Pocket Option'da ro'yxatdan o'ting va ID'ngizni quyiga kiriting.",
  gate_broker_step1: "1. Brokerda ro'yxatdan o'ting",
  gate_broker_step2: "2. Profildan UID'ni toping",
  gate_broker_step3: "3. UID'ni quyiga kiriting",
  gate_broker_btn_register: "🏦 Pocket Option ochish",
  gate_broker_uid_placeholder: "Sizning UID (raqamlar)",
  gate_broker_uid_hint: "UID odatda 6–8 raqamdan iborat, Pocket Option profilingizda topiladi",
  gate_broker_uid_hint_err: "UID 4–15 raqamdan iborat bo'lishi kerak",
  gate_broker_submit: "Arizani yuborish",
  gate_broker_submit_err: "Yuborish xatosi. Ulanishni tekshiring.",
  gate_broker_pending_title: "Ariza ko'rib chiqilmoqda",
  gate_broker_pending_desc: "UID yuborildi. Tasdiqlash 24 soatgacha. Sizga bildirishnoma keladi.",
  gate_broker_rejected: "Ariza rad etildi. Bizning linkimiz orqali ro'yxatdan o'tganingizga ishonch hosil qiling.",
  gate_error: "Kirish xatosi", gate_retry: "Qayta urinish",
  timeframe_title: "Tugatish vaqtini tanlang",
  timeframe_subtitle: "Natijani qachon tekshirish kerak?",
};

STR.tg = {
  brand_top: "TRADE", brand_bottom: "BOT", status: "СТАНДАРТӢ",
  search: "Ҷустуҷӯи актив...",
  lang_title: "Забон", lang_ru: "Русский", lang_en: "English",
  blocks: {
    assets: { title: "АКТИВҲО",      sub: "121 асбоб" },
    edu:    { title: "ТАЪЛИМ",       sub: "5 модул + китобҳо" },
    calc:   { title: "КАЛКУЛЯТОР",   sub: "Мартингейл + хатар" },
    news:   { title: "ХАБАРҲО",      sub: "Тақвим · имрӯз 14" },
    ind:    { title: "ИНДИКАТОРҲО",  sub: "6 классикӣ" },
  },
  assets_count_suffix: "актив",
  cats: { fiat: "Асъор", otc: "OTC асъор", crypto: "Криптовалютаҳо", stocks: "Саҳмияҳо", comm: "Ашёи хом", idx: "Индексҳо", fav: "Дӯстдоштаҳо" },
  cat_short: { fiat: "💵 FX", otc: "💵 OTC", crypto: "₿ Крипто", stocks: "📊 Саҳмия", comm: "🛢 Ашё", idx: "📈 Индекс", fav: "⭐ Дӯст." },
  edu_tabs: { basics: "Асосҳои савдо", books: "Китобҳо" },
  news_cols: { time: "Вақт", prio: "Аҳам.", left: "Боқӣ", event: "Воқеа" },
  news_time_fmt: (h, m) => `${h}с ${m}д`,
  analyze_market: "ТАҲЛИЛИ БОЗОР", analyze_loading: "АЛГОРИТМ ИҶРО МЕШАВАД...",
  scanning: "БОЗОР СКАНЕР МЕШАВАД...", analyzing_signal: "СИГНАЛ ТАҲЛИЛ МЕШАВАД...",
  analyzing_volatility: "ҶАҲИШҲО ТАҲЛИЛ МЕШАВАНД...", finalizing: "ПЕШГӮӢ ТАКМИЛ МЕЁБАД...",
  buy: "ХАРИДАН", sell: "ФУРӮХТАН", market: "Бозор", time_label: "Вақт",
  valid_until: "Эътибор то", retry: "Аз нав", back: "Бозгашт",
  tag_signal_ai: "СИГНАЛИ AI", tag_signal: "СИГНАЛ", tag_edu: "ТАЪЛИМ",
  tag_ind: "ИНДИКАТОР", tag_asset_analysis: "ТАҲЛИЛИ АКТИВ",
  dir_up: "БОЛО", dir_down: "ПОЁН",
  probability: "Эҳтимолият", expiration: "Анҷом",
  entry: "Воридшавӣ", target: "Ҳадаф", accept_signal: "СИГНАЛРО ҚАБУЛ КУНЕД",
  processing: "Алгоритми AI маълумотро коркард мекунад...",
  step_volatility: "› санҷиши ҷаҳишҳо",
  step_rsi: "› ҳисоби RSI + MACD",
  step_patterns: "› намунаҳои шамъ",
  demo_note: "⚠ Сигнали демо. Дар истеҳсолот хуруҷи модели ML.",
  demo_note_market: "⚠ Сигнали демо. Дар истеҳсолот хуруҷи ML/API.",
  gate_loading: "Дастрасӣ санҷида мешавад...",
  gate_channel_title: "Ба канал обуна шавед",
  gate_channel_desc: "Барои дастрасӣ ба сигналҳо ба канали таҳлилии мо обуна шавед.",
  gate_channel_btn: "📣 Канал кушодан", gate_check_btn: "Обуна шудам, санҷидан",
  gate_broker_title: "Дар Pocket Option номнавис кунед",
  gate_broker_desc: "Барои дастрасии пурра тавассути линки шарикии мо дар Pocket Option номнавис шавед ва ID-и худро ворид кунед.",
  gate_broker_step1: "1. Дар брокер номнавис шавед",
  gate_broker_step2: "2. UID-ро дар профил ёбед",
  gate_broker_step3: "3. UID-ро дар поён ворид кунед",
  gate_broker_btn_register: "🏦 Pocket Option кушодан",
  gate_broker_uid_placeholder: "UID-и шумо (рақамҳо)",
  gate_broker_uid_hint: "UID одатан 6–8 рақам аст, дар профили Pocket Option ёфт мешавад",
  gate_broker_uid_hint_err: "UID бояд 4–15 рақам бошад",
  gate_broker_submit: "Дархост фиристодан",
  gate_broker_submit_err: "Хатои фиристодан. Пайвастро санҷед.",
  gate_broker_pending_title: "Дархост дар баррасӣ",
  gate_broker_pending_desc: "UID фиристода шуд. Тасдиқ то 24 соат. Хабар мерасонад.",
  gate_broker_rejected: "Дархост рад шуд. Бо линки мо номнавис шудаатонро санҷед.",
  gate_error: "Хатои дастрасӣ", gate_retry: "Аз нав",
  timeframe_title: "Вақти анҷомро интихоб кунед",
  timeframe_subtitle: "Натиҷаро кай санҷидан?",
};

STR.kk = {
  brand_top: "TRADE", brand_bottom: "BOT", status: "СТАНДАРТ",
  search: "Актив іздеу...",
  lang_title: "Тіл", lang_ru: "Русский", lang_en: "English",
  blocks: {
    assets: { title: "АКТИВТЕР",      sub: "121 құрал" },
    edu:    { title: "БІЛІМ БЕРУ",    sub: "5 модуль + кітаптар" },
    calc:   { title: "КАЛЬКУЛЯТОР",   sub: "Мартингейл + тәуекел" },
    news:   { title: "ЖАҢАЛЫҚТАР",    sub: "Күнтізбе · бүгін 14" },
    ind:    { title: "ИНДИКАТОРЛАР",  sub: "6 классикалық" },
  },
  assets_count_suffix: "актив",
  cats: { fiat: "Валюталар", otc: "OTC валюталар", crypto: "Криптовалюталар", stocks: "Акциялар", comm: "Шикізат", idx: "Индекстер", fav: "Таңдаулылар" },
  cat_short: { fiat: "💵 FX", otc: "💵 OTC", crypto: "₿ Крипто", stocks: "📊 Акция", comm: "🛢 Шикізат", idx: "📈 Индекс", fav: "⭐ Таңд." },
  edu_tabs: { basics: "Трейдинг негіздері", books: "Кітаптар" },
  news_cols: { time: "Уақыт", prio: "Маңы.", left: "Қалды", event: "Оқиға" },
  news_time_fmt: (h, m) => `${h}с ${m}м`,
  analyze_market: "НАРЫҚТЫ ТАЛДАУ", analyze_loading: "АЛГОРИТМ ОРЫНДАЛУДА...",
  scanning: "НАРЫҚ СКАНЕРЛЕНУДЕ...", analyzing_signal: "СИГНАЛ ТАЛДАНУДА...",
  analyzing_volatility: "ҚҰБЫЛМАЛЫЛЫҚ ТАЛДАНУДА...", finalizing: "БОЛЖАУ АЯҚТАЛУДА...",
  buy: "САТЫП АЛУ", sell: "САТУ", market: "Нарық", time_label: "Уақыт",
  valid_until: "Жарамды", retry: "Қайта", back: "Артқа",
  tag_signal_ai: "AI СИГНАЛЫ", tag_signal: "СИГНАЛ", tag_edu: "БІЛІМ",
  tag_ind: "ИНДИКАТОР", tag_asset_analysis: "АКТИВ ТАЛДАУЫ",
  dir_up: "ЖОҒАРЫ", dir_down: "ТӨМЕН",
  probability: "Ықтималдық", expiration: "Аяқталу",
  entry: "Кіру", target: "Мақсат", accept_signal: "СИГНАЛДЫ ҚАБЫЛДАУ",
  processing: "ЖИ алгоритмі деректерді өңдеуде...",
  step_volatility: "› құбылмалылықты тексеру",
  step_rsi: "› RSI + MACD есебі",
  step_patterns: "› шам үлгілері",
  demo_note: "⚠ Демо сигнал. Өндірісте ML моделінің шығысы.",
  demo_note_market: "⚠ Демо сигнал. Өндірісте ML/API шығысы.",
  gate_loading: "Қол жетімділік тексерілуде...",
  gate_channel_title: "Каналға жазылыңыз",
  gate_channel_desc: "Сигналдарға қол жеткізу үшін біздің талдау арнамызға жазылыңыз.",
  gate_channel_btn: "📣 Каналды ашу", gate_check_btn: "Жазылдым, тексеру",
  gate_broker_title: "Pocket Option-та тіркеліңіз",
  gate_broker_desc: "Толық қол жеткізу үшін біздің серіктестік сілтемесі арқылы Pocket Option-та тіркеліп, ID-ңызды енгізіңіз.",
  gate_broker_step1: "1. Брокерде тіркеліңіз",
  gate_broker_step2: "2. Профильден UID табыңыз",
  gate_broker_step3: "3. UID-ді төменге енгізіңіз",
  gate_broker_btn_register: "🏦 Pocket Option ашу",
  gate_broker_uid_placeholder: "Сіздің UID (сандар)",
  gate_broker_uid_hint: "UID әдетте 6–8 саннан тұрады, Pocket Option профилінде",
  gate_broker_uid_hint_err: "UID 4–15 саннан тұруы керек",
  gate_broker_submit: "Өтінім жіберу",
  gate_broker_submit_err: "Жіберу қатесі. Байланысты тексеріңіз.",
  gate_broker_pending_title: "Өтінім қаралуда",
  gate_broker_pending_desc: "UID жіберілді. Мақұлдау 24 сағатқа дейін. Сізге хабарлама келеді.",
  gate_broker_rejected: "Өтінім қабылданбады. Біздің сілтеме арқылы тіркелгеніңізге көз жеткізіңіз.",
  gate_error: "Қол жеткізу қатесі", gate_retry: "Қайта",
  timeframe_title: "Аяқталу уақытын таңдаңыз",
  timeframe_subtitle: "Нәтижені қашан тексеру?",
};

STR.uk = {
  brand_top: "TRADE", brand_bottom: "BOT", status: "СТАНДАРТ",
  search: "Пошук активу...",
  lang_title: "Мова", lang_ru: "Русский", lang_en: "English",
  blocks: {
    assets: { title: "АКТИВИ",       sub: "121 інструмент" },
    edu:    { title: "НАВЧАННЯ",     sub: "5 модулів + книги" },
    calc:   { title: "КАЛЬКУЛЯТОР",  sub: "Мартингейл + ризик" },
    news:   { title: "НОВИНИ",       sub: "Календар · сьогодні 14" },
    ind:    { title: "ІНДИКАТОРИ",   sub: "6 класичних" },
  },
  assets_count_suffix: "активів",
  cats: { fiat: "Валюти", otc: "OTC валюти", crypto: "Криптовалюти", stocks: "Акції", comm: "Сировина", idx: "Індекси", fav: "Обране" },
  cat_short: { fiat: "💵 FX", otc: "💵 OTC", crypto: "₿ Крипто", stocks: "📊 Акції", comm: "🛢 Сировина", idx: "📈 Індекс", fav: "⭐ Обране" },
  edu_tabs: { basics: "Основи трейдингу", books: "Книги" },
  news_cols: { time: "Час", prio: "Важл.", left: "Зал.", event: "Подія" },
  news_time_fmt: (h, m) => `${h}г ${m}хв`,
  analyze_market: "АНАЛІЗ РИНКУ", analyze_loading: "АЛГОРИТМ ВИКОНУЄТЬСЯ...",
  scanning: "СКАНУВАННЯ РИНКУ...", analyzing_signal: "АНАЛІЗ СИГНАЛУ...",
  analyzing_volatility: "АНАЛІЗ ВОЛАТИЛЬНОСТІ...", finalizing: "ФІНАЛІЗАЦІЯ ПРОГНОЗУ...",
  buy: "КУПИТИ", sell: "ПРОДАТИ", market: "Ринок", time_label: "Час",
  valid_until: "Дійсний до", retry: "Спробувати ще", back: "Назад",
  tag_signal_ai: "AI СИГНАЛ", tag_signal: "СИГНАЛ", tag_edu: "НАВЧАННЯ",
  tag_ind: "ІНДИКАТОР", tag_asset_analysis: "АНАЛІЗ АКТИВУ",
  dir_up: "ВГОРУ", dir_down: "ВНИЗ",
  probability: "Ймовірність", expiration: "Закінчення",
  entry: "Вхід", target: "Ціль", accept_signal: "ПРИЙНЯТИ СИГНАЛ",
  processing: "AI алгоритм обробляє дані...",
  step_volatility: "› перевірка волатильності",
  step_rsi: "› розрахунок RSI + MACD",
  step_patterns: "› свічкові патерни",
  demo_note: "⚠ Демо-сигнал. У продакшені — вихід ML-моделі.",
  demo_note_market: "⚠ Демо-сигнал. У продакшені — вихід ML/API.",
  gate_loading: "Перевірка доступу...",
  gate_channel_title: "Підпишись на канал",
  gate_channel_desc: "Для доступу до сигналів підпишись на наш канал аналітики.",
  gate_channel_btn: "📣 Відкрити канал", gate_check_btn: "Я підписався, перевірити",
  gate_broker_title: "Зареєструйся на Pocket Option",
  gate_broker_desc: "Для повного доступу зареєструйся на Pocket Option через наше партнерське посилання і введи свій ID нижче.",
  gate_broker_step1: "1. Зареєструйся на брокері",
  gate_broker_step2: "2. Знайди UID у профілі",
  gate_broker_step3: "3. Введи UID нижче",
  gate_broker_btn_register: "🏦 Відкрити Pocket Option",
  gate_broker_uid_placeholder: "Ваш UID (цифри)",
  gate_broker_uid_hint: "UID зазвичай 6–8 цифр, знайдеш у профілі Pocket Option",
  gate_broker_uid_hint_err: "UID має містити 4–15 цифр",
  gate_broker_submit: "Надіслати заявку",
  gate_broker_submit_err: "Помилка надсилання. Перевір з'єднання.",
  gate_broker_pending_title: "Заявка на розгляді",
  gate_broker_pending_desc: "UID надіслано. Підтвердження до 24 годин. Отримаєш сповіщення.",
  gate_broker_rejected: "Заявку відхилено. Переконайся, що реєструвався через наше посилання.",
  gate_error: "Помилка доступу", gate_retry: "Спробувати ще",
  timeframe_title: "Обери час закінчення",
  timeframe_subtitle: "Коли перевірити результат?",
};
...
const STR_PROXY = {
  ...
  uz: makeProxy("uz"), tg: makeProxy("tg"),
  kk: makeProxy("kk"), uk: makeProxy("uk"),
};

const LANG_LIST = ["en", "ru", "es", "pt", "tr", "vi", "id", "hi", "uz", "tg", "kk", "uk"];
...
// Полный VIP-UI работает внутри Mini App (full-screen overlay).
// Все 12 локалей; отсутствующие ключи fallback на en.
const VIP_PANEL = {
  ru: {
    header: "VIP AI СИГНАЛЫ", sub: "Высокоуверенные сделки с разбором",
    ...
    direction_buy: "BUY · LONG", direction_sell: "SELL · SHORT",
    confidence: "Уверенность", expiry: "Экспирация", expiry_min: "мин",
    analysis: "Анализ",
    note_demo: "Демо-сигнал (Claude API не настроен).",
    note_ai: "Сигнал сгенерирован Claude AI.",
  ...
  en: {
    ...
    direction_buy: "BUY · LONG", direction_sell: "SELL · SHORT",
    confidence: "Confidence", expiry: "Expiry", expiry_min: "min",
    analysis: "Analysis",
    note_demo: "Demo signal (Claude API not configured).",
    note_ai: "Generated by Claude AI.",
  ...
  es: {
    ...
    locked_title: "VIP se desbloquea tras depósito",
    locked_desc: "Regístrate en Pocket Option y realiza un depósito — el acceso VIP se activa automáticamente.",
    btn_deposit: "Abrir Pocket Option",
    counter: "Señales hoy",
    btn_request: "Obtener señal VIP",
    btn_blocked: "Límite — reinicio a las {hour}:00 UTC",
    btn_loading: "Analizando mercado…",
    no_signal: "Toca el botón para obtener tu primera señal del día",
    direction_buy: "BUY · LONG", direction_sell: "SELL · SHORT",
    confidence: "Confianza", expiry: "Expiración", expiry_min: "min",
    analysis: "Análisis",
    note_demo: "Señal demo (Claude API no configurada).",
    note_ai: "Generado por Claude AI.",
    history: "Historial de señales",
    history_empty: "Aquí aparecerán tus señales pasadas",
    error_limit: "Límite diario alcanzado",
    error_generic: "Error — inténtalo de nuevo",
  },
  pt: {
    header: "SINAIS IA VIP", sub: "Operações de alta confiança com análise",
    locked_title: "VIP desbloqueia após depósito",
    locked_desc: "Cadastre-se na Pocket Option e faça um depósito — o acesso VIP é ativado automaticamente.",
    btn_deposit: "Abrir Pocket Option",
    counter: "Sinais hoje",
    btn_request: "Obter sinal VIP",
    btn_blocked: "Limite — reset às {hour}:00 UTC",
    btn_loading: "Analisando mercado…",
    no_signal: "Toque no botão para obter seu primeiro sinal hoje",
    direction_buy: "BUY · LONG", direction_sell: "SELL · SHORT",
    confidence: "Confiança", expiry: "Expiração", expiry_min: "min",
    analysis: "Análise",
    note_demo: "Sinal demo (Claude API não configurada).",
    note_ai: "Gerado pelo Claude AI.",
    history: "Histórico de sinais",
    history_empty: "Seus sinais anteriores aparecerão aqui",
    error_limit: "Limite diário atingido",
    error_generic: "Erro — tente novamente",
  },
  tr: {
    header: "VIP AI SİNYALLER", sub: "Analizli yüksek güvenilirlikli işlemler",
    locked_title: "VIP yatırım sonrası açılır",
    locked_desc: "Pocket Option'a kayıt ol ve yatırım yap — VIP erişim otomatik açılır.",
    btn_deposit: "Pocket Option'u aç",
    counter: "Bugünkü sinyaller",
    btn_request: "VIP sinyal al",
    btn_blocked: "Limit — {hour}:00 UTC sıfırlanır",
    btn_loading: "Piyasa analiz ediliyor…",
    no_signal: "Bugünkü ilk sinyali almak için butona dokun",
    direction_buy: "BUY · LONG", direction_sell: "SELL · SHORT",
    confidence: "Güven", expiry: "Süre", expiry_min: "dk",
    analysis: "Analiz",
    note_demo: "Demo sinyal (Claude API ayarlı değil).",
    note_ai: "Claude AI tarafından oluşturuldu.",
    history: "Sinyal geçmişi",
    history_empty: "Geçmiş sinyalleriniz burada görünecek",
    error_limit: "Günlük limit doldu",
    error_generic: "Hata — tekrar dene",
  },
  vi: {
    header: "TÍN HIỆU AI VIP", sub: "Giao dịch độ tin cậy cao kèm phân tích",
    locked_title: "VIP mở khóa sau khi nạp tiền",
    locked_desc: "Đăng ký Pocket Option và nạp tiền — quyền truy cập VIP kích hoạt tự động.",
    btn_deposit: "Mở Pocket Option",
    counter: "Tín hiệu hôm nay",
    btn_request: "Nhận tín hiệu VIP",
    btn_blocked: "Đã đạt giới hạn — reset lúc {hour}:00 UTC",
    btn_loading: "Đang phân tích thị trường…",
    no_signal: "Nhấn nút để nhận tín hiệu đầu tiên hôm nay",
    direction_buy: "BUY · LONG", direction_sell: "SELL · SHORT",
    confidence: "Độ tin cậy", expiry: "Hết hạn", expiry_min: "phút",
    analysis: "Phân tích",
    note_demo: "Tín hiệu demo (Claude API chưa cấu hình).",
    note_ai: "Được tạo bởi Claude AI.",
    history: "Lịch sử tín hiệu",
    history_empty: "Tín hiệu trước đây của bạn sẽ hiện ở đây",
    error_limit: "Đã đạt giới hạn hàng ngày",
    error_generic: "Lỗi — thử lại",
  },
  id: {
    header: "SINYAL AI VIP", sub: "Transaksi keyakinan tinggi dengan analisis",
    locked_title: "VIP terbuka setelah deposit",
    locked_desc: "Daftar di Pocket Option dan lakukan deposit — akses VIP aktif otomatis.",
    btn_deposit: "Buka Pocket Option",
    counter: "Sinyal hari ini",
    btn_request: "Ambil sinyal VIP",
    btn_blocked: "Limit — reset pukul {hour}:00 UTC",
    btn_loading: "Menganalisis pasar…",
    no_signal: "Ketuk tombol untuk dapat sinyal pertamamu hari ini",
    direction_buy: "BUY · LONG", direction_sell: "SELL · SHORT",
    confidence: "Keyakinan", expiry: "Kedaluwarsa", expiry_min: "mnt",
    analysis: "Analisis",
    note_demo: "Sinyal demo (Claude API belum dikonfigurasi).",
    note_ai: "Dihasilkan oleh Claude AI.",
    history: "Riwayat sinyal",
    history_empty: "Sinyal sebelumnya akan muncul di sini",
    error_limit: "Batas harian tercapai",
    error_generic: "Error — coba lagi",
  },
  hi: {
    header: "VIP AI सिग्नल", sub: "विश्लेषण के साथ उच्च-विश्वास ट्रेड",
    locked_title: "जमा के बाद VIP खुलता है",
    locked_desc: "Pocket Option पर रजिस्टर करें और जमा करें — VIP एक्सेस अपने आप चालू हो जाएगा।",
    btn_deposit: "Pocket Option खोलें",
    counter: "आज के सिग्नल",
    btn_request: "VIP सिग्नल पाएँ",
    btn_blocked: "लिमिट — रीसेट {hour}:00 UTC",
    btn_loading: "बाज़ार का विश्लेषण…",
    no_signal: "आज का पहला सिग्नल पाने के लिए बटन दबाएँ",
    direction_buy: "BUY · LONG", direction_sell: "SELL · SHORT",
    confidence: "विश्वास", expiry: "एक्सपायरी", expiry_min: "मिनट",
    analysis: "विश्लेषण",
    note_demo: "डेमो सिग्नल (Claude API सेट नहीं)।",
    note_ai: "Claude AI द्वारा बनाया गया।",
    history: "सिग्नल इतिहास",
    history_empty: "आपके पिछले सिग्नल यहाँ दिखेंगे",
    error_limit: "दैनिक सीमा समाप्त",
    error_generic: "त्रुटि — फिर कोशिश करें",
  },
  uz: {
    header: "VIP AI SIGNALLAR", sub: "Tahlil bilan yuqori ishonchli savdolar",
    locked_title: "VIP depozitdan keyin ochiladi",
    locked_desc: "Pocket Option'da ro'yxatdan o'ting va depozit qiling — VIP-kirish avtomatik faollashadi.",
    btn_deposit: "Pocket Option'ni ochish",
    counter: "Bugun signallar",
    btn_request: "VIP signal olish",
    btn_blocked: "Limit — {hour}:00 UTC da yangilanadi",
    btn_loading: "Bozor tahlil qilinmoqda…",
    no_signal: "Bugungi birinchi signalingizni olish uchun tugmani bosing",
    direction_buy: "BUY · LONG", direction_sell: "SELL · SHORT",
    confidence: "Ishonch", expiry: "Tugash", expiry_min: "daq",
    analysis: "Tahlil",
    note_demo: "Demo signal (Claude API sozlanmagan).",
    note_ai: "Claude AI tomonidan yaratildi.",
    history: "Signallar tarixi",
    history_empty: "Avvalgi signallaringiz shu yerda paydo bo'ladi",
    error_limit: "Kunlik limit tugadi",
    error_generic: "Xato — qayta urinib ko'ring",
  },
  tg: {
    header: "VIP AI СИГНАЛҲО", sub: "Савдоҳои эътимоди баланд бо таҳлил",
    locked_title: "VIP пас аз депозит кушода мешавад",
    locked_desc: "Дар Pocket Option номнавис шавед ва депозит кунед — дастрасии VIP худкор фаъол мешавад.",
    btn_deposit: "Кушодани Pocket Option",
    counter: "Сигналҳои имрӯз",
    btn_request: "VIP-сигнал гирифтан",
    btn_blocked: "Лимит — навсозӣ дар {hour}:00 UTC",
    btn_loading: "Бозор таҳлил мешавад…",
    no_signal: "Барои гирифтани сигнали аввал ба тугма пахш кунед",
    direction_buy: "BUY · LONG", direction_sell: "SELL · SHORT",
    confidence: "Эътимод", expiry: "Мӯҳлат", expiry_min: "дақ",
    analysis: "Таҳлил",
    note_demo: "Сигнали демо (Claude API танзим нашудааст).",
    note_ai: "Аз ҷониби Claude AI сохта шудааст.",
    history: "Таърихи сигналҳо",
    history_empty: "Сигналҳои гузаштаи шумо дар ин ҷо пайдо мешаванд",
    error_limit: "Лимити рӯзона расид",
    error_generic: "Хатогӣ — боз кӯшиш кунед",
  },
  kk: {
    header: "VIP AI СИГНАЛДАР", sub: "Талдаумен жоғары сенімді сауда",
    locked_title: "VIP депозитен кейін ашылады",
    locked_desc: "Pocket Option-да тіркеліп, депозит жасаңыз — VIP қолжетімділік автоматты түрде белсендіріледі.",
    btn_deposit: "Pocket Option-ды ашу",
    counter: "Бүгінгі сигналдар",
    btn_request: "VIP сигнал алу",
    btn_blocked: "Лимит — жаңару {hour}:00 UTC",
    btn_loading: "Нарық талдануда…",
    no_signal: "Бүгінгі бірінші сигналды алу үшін түймені басыңыз",
    direction_buy: "BUY · LONG", direction_sell: "SELL · SHORT",
    confidence: "Сенім", expiry: "Мерзім", expiry_min: "мин",
    analysis: "Талдау",
    note_demo: "Демо сигнал (Claude API орнатылмаған).",
    note_ai: "Claude AI жасады.",
    history: "Сигналдар тарихы",
    history_empty: "Сіздің бұрынғы сигналдарыңыз осында пайда болады",
    error_limit: "Күнделікті лимит біткен",
    error_generic: "Қате — қайта көріңіз",
  },
  uk: {
    header: "VIP AI СИГНАЛИ", sub: "Високовпевнені угоди з аналізом",
    locked_title: "VIP відкривається після депозиту",
    locked_desc: "Зареєструйся на Pocket Option і внеси депозит — VIP-доступ активується автоматично.",
    btn_deposit: "Відкрити Pocket Option",
    counter: "Сигналів сьогодні",
    btn_request: "Отримати VIP-сигнал",
    btn_blocked: "Ліміт — оновлення о {hour}:00 UTC",
    btn_loading: "Аналізую ринок…",
    no_signal: "Натисни кнопку, щоб отримати перший сигнал на сьогодні",
    direction_buy: "BUY · LONG", direction_sell: "SELL · SHORT",
    confidence: "Впевненість", expiry: "Експірація", expiry_min: "хв",
    analysis: "Аналіз",
    note_demo: "Демо-сигнал (Claude API не налаштовано).",
    note_ai: "Згенеровано Claude AI.",
    history: "Історія сигналів",
    history_empty: "Тут зʼявляться сигнали, які ти отримав",
    error_limit: "Денний ліміт вичерпано",
    error_generic: "Помилка — спробуй ще раз",
  },
};
...
export default function TradeAppBot() {
  ...
  useEffect(() => {
    ...
    try {
      ...
      const langMap = {
        ru: "ru", be: "ru",          // русскоязычные
        uk: "uk",                    // украинский — теперь отдельный
        kk: "kk",                    // казахский — теперь отдельный
        uz: "uz",                    // узбекский
        tg: "tg",                    // таджикский
        es: "es",
        pt: "pt", "pt-br": "pt",
  ...
  async function requestSignal() {
    ...
    try {
      ...
      if (r.status === 429) {
        ...
        // Prepend в локальную историю (без повторного fetch)
        setHistory(h => [{ ...d.signal, source: d.source, generated_at: d.generated_at }, ...h].slice(0, 20));
      }
    } catch {
      setError(T.error_generic);
    } finally {
      ...
      <div className="relative z-10 px-5 pt-6 pb-12 max-w-md mx-auto">
        ...
        {status?.is_vip && category && (
          <div className="space-y-5">
            ...
            {/* История сигналов */}
            <div className="pt-4">
              <div className="text-[11px] text-neutral-500 uppercase tracking-wider mb-3 px-1">
                {T.history}
              </div>
              {history.length === 0 ? (
